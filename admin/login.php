...
<title>Manabo, National High School.</title>

<!-- Bootstrap core CSS -->
<link href="<?php echo web_root; ?>css/mystyle.css" rel="stylesheet">
      ...
      <section class="login-form"> <? echo check_message(); ?>;
        <form method="post" action="" role="login">
          <!-- <img src="http://i.imgur.com/RcmcLv4.png" class="img-responsive" alt="" /> -->
           <img src="../img/logo1.jpg" height="25px" class="img-responsive" alt="" />
