   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img src="<?php echo web_root; ?>img/logo1.jpg" height="23">
                Manabo National Senior Hig School</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right"> 
                 <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="<?php echo web_root; ?>admin/course/index.php?view=add"><i class="fa  fa-graduation-cap fa-fw"></i> Strand</a>
...
?> 
   ...
   <!-- /input-group -->
                        ...
                        <li>
                         ...
                         <li>
                             <a href="<?php echo web_root; ?>admin/course/index.php" ><i class="fa  fa-graduation-cap fa-fw"></i>  Strand </a>
