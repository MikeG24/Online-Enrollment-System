 ...
 <div class="row">
            ...
            <div class="col-md-8">
                ...
                <p>
                   Manabo SHS National High School
                <br>San Jose Sur, Manabo, Abra, Philippines<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: (083) 228-9722</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email</abbr>: <a href="mailto:name@example.com">Admission@mnhsph.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: Monday - Friday: 7:00 AM to 5:00 PM</p>
                       ...
                       <!--  <div class="panel-heading">
                        ...
                        <div class="panel-body">
                            <p>
                               ...
                               Manabo National High School(SHS-enrollment).: A Culture of Global Leadership, Quality and Excellence.

                                     

                                   <h1>  MISSION</h1>

                                   Manabo National High School(SHS-enrollment). is committed to develop academic and technopreneurial competencies, facilitate learning experiences and assure the highest standards of quality and excellence and institutional integrity.
