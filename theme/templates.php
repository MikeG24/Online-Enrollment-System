...
<title><?php echo $title; ?> | Manabo National High School(SHS-enrollment).</title>
...
<div class="navbar-fixed-top navbar-TOPsm  col-md-10    col-md-offset-1"    role="navigation">
  <div class="container">
    <div class="navbar-header">
          <h5 class="navbar-menu p" >Manabo National High School(SHS-enrollment).</h5>
        ...
        <ul class="navbar-nav p navbar-left tooltip-demo" style="margin-left:-8%;"> 
            <li class="dropdown dropdown-toggle ">
              <a  data-toggle="tooltip" data-placement="left" title="Contact Us"   href="<?php echo web_root.'index.php?q=contact';  ?>"> 
               <i class="fa fa-phone fa-fw"> </i>  Call Us: (083) 228-9722 OR Email Us: Admission@mnhsph.com
              </a>
            </li>
            <li><span>    ||    </span></li>
            <li>
   ...
   <div class="col-md-4">
    <div class="row "> 
     <p > 
        ...
        <h1 align="center" >Manabo National High School(SHS-enrollment).</h1>
        </a>
    </p>
...
?>
            ...
            <footer class="panel-footer" style="background-color:#098744;color:#fff;" >
              <p align="left" >&copy; Manabo National High School(SHS-enrollment).</p>
           </footer>
      </div>
